document.addEventListener('DOMContentLoaded', () => {
  ...
  // ========== RECORD DETAIL MODAL (remaining injections per person) ==========
  function buildMaternalRecordMap() {
    const map = {};
  ...
  function renderRecordDetail(code) {
    const rec = buildMaternalRecordMap()[code];
    if (!rec) return;

    const isChild = rec.type !== 'Pregnant';
